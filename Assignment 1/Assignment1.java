...
public class Assignment1 {
    public static void main(String[] args){
        ...
        float totalMoney = twenties.getTotalValue() + tens.getTotalValue() + fives.getTotalValue() + ones.getTotalValue() +
        ...
        System.out.println("Total Money is $" + String.format("%4.2f", totalMoney) + " total weight is " + totalWeight + "oz");
        ...
        while (amount >= 0.05 && nickels.getQuantityOnHand() > 0){
        ...
        if(amount > 0.001){
            System.out.println("I don't have enough money. I still owe you $" + String.format("%4.2f", amount));
        }
        totalMoney = twenties.getTotalValue() + tens.getTotalValue() + fives.getTotalValue() + ones.getTotalValue() +
                quarters.getTotalValue() + dimes.getTotalValue() + nickels.getTotalValue() + pennies.getTotalValue();

        totalWeight = quarters.getTotalWeight() + dimes.getTotalWeight() + nickels.getTotalWeight() + pennies.getTotalWeight();

        System.out.printf("I have $" + String.format("%4.2f", totalMoney)  + " left, it's total weight is" + totalWeight + "oz");
    }
}
